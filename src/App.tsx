      ...
      <IonApp>
        <IonReactRouter>
          <IonRouterOutlet>
            ...
            <Route path="/education-completed">
            ...
            <Route path="/verify-email/:email">
              <Suspense fallback={<LoadingVerifyEmail />}>
                <VerifyEmailPage />
              </Suspense>
            </Route>

            <Route path="/verify-email/:email/:code">
              <Suspense fallback={<LoadingVerifyEmail />}>
                <VerifyEmailPage />
              </Suspense>
            </Route>
            ...
            <PrivateRoute path="/assignment/:id">
            ...
            <PrivateRoute path="/discounts/:id">
            ...
            <PrivateRoute path="/invitation/:id">
            ...
            <PrivateRoute path="/work-history">
              <Suspense fallback={<LoadingWorkHistory />}>
                <WorkHistoryPage />
              </Suspense>
            </PrivateRoute>

            <PrivateRoute path="/work-log/appeal/:id">
              <Suspense fallback={<LoadingAppeal />}>
                <AppealDetailPage />
              </Suspense>
            </PrivateRoute>

            <PrivateRoute path="/work-log/log-date-list">
              <Suspense fallback={<LoadingLogDateList />}>
                <LogDateListPage />
              </Suspense>
            </PrivateRoute>

            <PrivateRoute path="/work-log/log-hour-list/:date">
              <Suspense fallback={<LoadingLogHourList />}>
                <LogHourListPage />
              </Suspense>
            </PrivateRoute>

            <PrivateRoute path="/work-log/track-work">
