        ...
        <DayPicker
            ...
            classNames={{
                ...
                button_previous: cn(
                    ...
                    "absolute start-0 top-0 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"
                ),
                button_next: cn(
                    buttonVariants({ variant: "outline" }),
                    "absolute end-0 top-0 h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100"
                ),
